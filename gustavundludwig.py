...
time.sleep(2)
print(playerName + ": Was ist das?")
time.sleep(2)
print(char2 + ": (nervoes) Oh, das ist ein altes Foto von Gustav und mir. Wir waren hier frueher oft.")
time.sleep(2)
print("Du hast nun die Moeglichkeit dich umzusehen. Du kannst SUCHEN und SPRECHEN.")
def suchen():
    print("Du findest Antonias Notizbuch.")
    exec(open("antoniasnotepad.py").read())
...
while True:
    ...
    if choice == "suchen":
        ...
        print(playerName + ": Ich glaub Ludwig hat was zu verbergen.")
